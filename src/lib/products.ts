...
import necklaceHematiteRhodium from "@/assets/product-necklace-hematite-rhodium-v2.jpg";
import necklaceHematiteCharms from "@/assets/product-necklace-hematite-charms-v2.jpg";
import necklacePearlHeart from "@/assets/product-necklace-pearl-heart-v2.png";
import necklacePearlFlower from "@/assets/product-necklace-pearl-flower-v2.png";
import necklacePearlHorse from "@/assets/product-necklace-pearl-horse-v2.jpg";
import necklaceMarcasiteAgateBow from "@/assets/product-necklace-marcasite-agate-bow-v2.jpg";
...
export const products: Product[] = [
  ...
  },
  {
    id: "nk-pearl-horse",
    category: "necklaces",
    name: "Жемчуг · чокер с подвеской-лошадкой",
    mood: "Жемчужный чокер с изящной подвеской-лошадкой в позолоте",
  ...
  },
  {
    ...
    materials: "натуральный чёрный агат, подвеска-сумка, фурнитура латунь с родиевым покрытием",
    size: "универсальный",
    price: "2 000 ₽",
  ...
  },
  {
    ...
    materials: "натуральный горный хрусталь, гранёные бусины, подвеска-сумочка",
    size: "универсальный",
    price: "2 200 ₽",
